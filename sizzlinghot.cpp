    ...
    if (getch()) {
        ...
        while (1) {
            ...
            if (key == 'c') {
                ...
                cout << " __   __  _______  ___      ___      _______  _     _  _______  ___   ______   _______  _______ " << endl;
                cout << "|  | |  ||       ||   |    |   |    |       || | _ | ||       ||   | |      | |       ||       |" << endl;
                cout << "|  |_|  ||    ___||   |    |   |    |   _   || || || ||_     _||   | |  _    ||    ___||  _____|" << endl;
                cout << "|       ||   |___ |   |    |   |    |  | |  ||       |  |   |  |   | | | |   ||   |___ | |_____ " << endl;
                cout << "|_     _||    ___||   |___ |   |___ |  |_|  ||       |  |   |  |   | | |_|   ||    ___||_____  |" << endl;
                cout << "  |   |  |   |___ |       ||       ||       ||   _   |  |   |  |   | |       ||   |___  _____| |" << endl;
                cout << "  |___|  |_______||_______||_______||_______||__| |__|  |___|  |___| |______| |_______||_______|" << endl;
                int key2 = getch();
                if (key2 == 'c') {
                    system("cls");
                    for (i = 1; i <= 3; i++) {
